...
Every block opens the same way, plan 1 included:

`## PLAN 1 of 3 · <today's date>`

`PLAN 1 of 3 · LANE <lane> · hours a day <N> · week 1 <Monday's date> · renew <Monday's date> · confirmed <date>`

Week 1 starts the Monday after the day the plan is written (today, when today is a Monday). The
renew date is the Monday after week 4; the renewal itself is written on week 4's Sunday.
...
| The plan | |
|---|---|
| The block | `9:00 am to 11:00 am, Monday to Saturday` for 2 hours, proposed at 9:00 am and confirmed or changed at the yes. Sunday has no block |
| The hour | `1 hour a day on people, by hand. A habit, not a count.` The same line in every plan |
| The send or publish day | OUTREACH `Wednesday: the week's list enters`. CONTENT `Wednesday: the video is published`. ADS `Wednesday: the new ad set goes live on your go` |
| The read lag | `Sunday reads only what has finished: a batch past its last touch, a video past 7 days, an ad set past 7 days and about 50 results. The rest is held, never guessed.` |
...
|---|---|
| minutes a day for the system | 2 x 60 = 120 |
| the making, Monday and Tuesday | 240 minutes: the winner copied, packaged and scripted, and Tuesday's block is the record |
| 1 recording a week | published Wednesday, the same slot every week; Wednesday's minutes go on the cut and the listing, Thursday to Saturday on the replies |

ADS, worked at 2 hours a day and a $100 daily number:

| The arithmetic | |
|---|---|
| spend | the money card's daily number (a2), all 7 days: worked here at $100 a day, $700 a week, behind a1's gate. No card, this row reads `your daily number (a2)` and no figure is printed |
...
| The plan | |
|---|---|
| The block | 9:00 am to 11:00 am, Monday to Saturday. Sunday has no block |
| The hour | 1 hour a day on people, by hand. A habit, not a count. |
| The send or publish day | Wednesday: the week's list enters |
| The read lag | Sunday reads only what has finished: a batch past its last touch, a video past 7 days, an ad set past 7 days and about 50 results. The rest is held, never guessed. |
